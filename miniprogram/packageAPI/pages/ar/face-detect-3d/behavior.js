                ...
                session.start(err => {
                    ...
                    session.on('updateAnchors', anchors => {
                        ...
                        for (let i = 0; i < anchors.length; i++ ) {
                            ...
                            console.log('camExtArray', anchor.camExtArray);
                            console.log('camIntArray', anchor.camIntArray);
                            console.log('points', anchor.points);
                            console.log('angle', anchor.angle);
