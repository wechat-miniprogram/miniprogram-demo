...
$root.GenWxaCloudTmpCodeReq = (function () {
  ...
  GenWxaCloudTmpCodeReq.encode = function encode(message, writer) {
    ...
    if (message.CloudPlatform != null && message.hasOwnProperty('CloudPlatform')) writer.uint32(/* id 1, wireType 0 = */8).uint32(message.CloudPlatform)
    if (message.AppUin != null && message.hasOwnProperty('AppUin')) writer.uint32(/* id 2, wireType 0 = */16).uint32(message.AppUin)
    if (message.UserUin != null && message.hasOwnProperty('UserUin')) writer.uint32(/* id 3, wireType 0 = */24).uint32(message.UserUin)
    return writer
  }
  ...
  GenWxaCloudTmpCodeReq.decode = function decode(reader, length) {
    ...
    var end = length === undefined ? reader.len : reader.pos + length; var
      message = new $root.GenWxaCloudTmpCodeReq()
  ...
  GenWxaCloudTmpCodeReq.verify = function verify(message) {
    ...
    if (message.CloudPlatform != null && message.hasOwnProperty('CloudPlatform')) if (!$util.isInteger(message.CloudPlatform)) return 'CloudPlatform: integer expected'
    if (message.AppUin != null && message.hasOwnProperty('AppUin')) if (!$util.isInteger(message.AppUin)) return 'AppUin: integer expected'
    if (message.UserUin != null && message.hasOwnProperty('UserUin')) if (!$util.isInteger(message.UserUin)) return 'UserUin: integer expected'
    return null
  }
  ...
  GenWxaCloudTmpCodeReq.fromObject = function fromObject(object) {
    if (object instanceof $root.GenWxaCloudTmpCodeReq) return object
    var message = new $root.GenWxaCloudTmpCodeReq()
    if (object.CloudPlatform != null) message.CloudPlatform = object.CloudPlatform >>> 0
    if (object.AppUin != null) message.AppUin = object.AppUin >>> 0
    if (object.UserUin != null) message.UserUin = object.UserUin >>> 0
    return message
  }
  ...
  GenWxaCloudTmpCodeReq.toObject = function toObject(message, options) {
    ...
    if (message.CloudPlatform != null && message.hasOwnProperty('CloudPlatform')) object.CloudPlatform = message.CloudPlatform
    if (message.AppUin != null && message.hasOwnProperty('AppUin')) object.AppUin = message.AppUin
    if (message.UserUin != null && message.hasOwnProperty('UserUin')) object.UserUin = message.UserUin
    return object
  }
...
$root.GenWxaCloudTmpCodeResp = (function () {
  ...
  GenWxaCloudTmpCodeResp.encode = function encode(message, writer) {
    if (!writer) writer = $Writer.create()
    if (message.TmpCode != null && message.hasOwnProperty('TmpCode')) writer.uint32(/* id 1, wireType 2 = */10).string(message.TmpCode)
    return writer
  }
  ...
  GenWxaCloudTmpCodeResp.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
    var end = length === undefined ? reader.len : reader.pos + length; var
      message = new $root.GenWxaCloudTmpCodeResp()
    while (reader.pos < end) {
      var tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
  ...
  GenWxaCloudTmpCodeResp.verify = function verify(message) {
    if (typeof message !== 'object' || message === null) return 'object expected'
    if (message.TmpCode != null && message.hasOwnProperty('TmpCode')) if (!$util.isString(message.TmpCode)) return 'TmpCode: string expected'
    return null
  }
  ...
  GenWxaCloudTmpCodeResp.fromObject = function fromObject(object) {
    if (object instanceof $root.GenWxaCloudTmpCodeResp) return object
    var message = new $root.GenWxaCloudTmpCodeResp()
    if (object.TmpCode != null) message.TmpCode = String(object.TmpCode)
    return message
  }
  ...
  GenWxaCloudTmpCodeResp.toObject = function toObject(message, options) {
    if (!options) options = {}
    var object = {}
    if (options.defaults) object.TmpCode = ''
    if (message.TmpCode != null && message.hasOwnProperty('TmpCode')) object.TmpCode = message.TmpCode
    return object
  }
...
$root.GetWeAppMemberByUserReq = (function () {
  ...
  GetWeAppMemberByUserReq.encode = function encode(message, writer) {
    if (!writer) writer = $Writer.create()
    if (message.useruin != null && message.hasOwnProperty('useruin')) writer.uint32(/* id 1, wireType 0 = */8).uint32(message.useruin)
    if (message.type != null && message.hasOwnProperty('type')) writer.uint32(/* id 2, wireType 0 = */16).uint32(message.type)
    if (message.status != null && message.hasOwnProperty('status')) writer.uint32(/* id 3, wireType 0 = */24).uint32(message.status)
    return writer
  }
  ...
  GetWeAppMemberByUserReq.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
    var end = length === undefined ? reader.len : reader.pos + length; var
      message = new $root.GetWeAppMemberByUserReq()
    while (reader.pos < end) {
      var tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
  ...
  GetWeAppMemberByUserReq.fromObject = function fromObject(object) {
    if (object instanceof $root.GetWeAppMemberByUserReq) return object
...
$root.WeAppMemberInfo = (function () {
  ...
  WeAppMemberInfo.encode = function encode(message, writer) {
    ...
    if (message.weappuin != null && message.hasOwnProperty('weappuin')) writer.uint32(/* id 2, wireType 0 = */16).uint32(message.weappuin)
    if (message.useruin != null && message.hasOwnProperty('useruin')) writer.uint32(/* id 3, wireType 0 = */24).uint32(message.useruin)
    if (message.status != null && message.hasOwnProperty('status')) writer.uint32(/* id 4, wireType 0 = */32).uint32(message.status)
    if (message.createtime != null && message.hasOwnProperty('createtime')) writer.uint32(/* id 5, wireType 0 = */40).uint32(message.createtime)
    if (message.updatetime != null && message.hasOwnProperty('updatetime')) writer.uint32(/* id 6, wireType 0 = */48).uint32(message.updatetime)
    if (message.ticket != null && message.hasOwnProperty('ticket')) writer.uint32(/* id 7, wireType 2 = */58).string(message.ticket)
    return writer
  }
  ...
  WeAppMemberInfo.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
    var end = length === undefined ? reader.len : reader.pos + length; var
      message = new $root.WeAppMemberInfo()
    while (reader.pos < end) {
      var tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
  ...
  WeAppMemberInfo.verify = function verify(message) {
    if (typeof message !== 'object' || message === null) return 'object expected'
    if (message.type != null && message.hasOwnProperty('type')) if (!$util.isInteger(message.type)) return 'type: integer expected'
    if (message.weappuin != null && message.hasOwnProperty('weappuin')) if (!$util.isInteger(message.weappuin)) return 'weappuin: integer expected'
    if (message.useruin != null && message.hasOwnProperty('useruin')) if (!$util.isInteger(message.useruin)) return 'useruin: integer expected'
    if (message.status != null && message.hasOwnProperty('status')) if (!$util.isInteger(message.status)) return 'status: integer expected'
    if (message.createtime != null && message.hasOwnProperty('createtime')) if (!$util.isInteger(message.createtime)) return 'createtime: integer expected'
    if (message.updatetime != null && message.hasOwnProperty('updatetime')) if (!$util.isInteger(message.updatetime)) return 'updatetime: integer expected'
    if (message.ticket != null && message.hasOwnProperty('ticket')) if (!$util.isString(message.ticket)) return 'ticket: string expected'
    return null
  }
  ...
  WeAppMemberInfo.fromObject = function fromObject(object) {
    if (object instanceof $root.WeAppMemberInfo) return object
    var message = new $root.WeAppMemberInfo()
    if (object.type != null) message.type = object.type >>> 0
    if (object.weappuin != null) message.weappuin = object.weappuin >>> 0
    if (object.useruin != null) message.useruin = object.useruin >>> 0
    if (object.status != null) message.status = object.status >>> 0
    if (object.createtime != null) message.createtime = object.createtime >>> 0
    if (object.updatetime != null) message.updatetime = object.updatetime >>> 0
    if (object.ticket != null) message.ticket = String(object.ticket)
    return message
  }
  ...
  WeAppMemberInfo.toObject = function toObject(message, options) {
    ...
    if (message.type != null && message.hasOwnProperty('type')) object.type = message.type
    if (message.weappuin != null && message.hasOwnProperty('weappuin')) object.weappuin = message.weappuin
    if (message.useruin != null && message.hasOwnProperty('useruin')) object.useruin = message.useruin
    if (message.status != null && message.hasOwnProperty('status')) object.status = message.status
    if (message.createtime != null && message.hasOwnProperty('createtime')) object.createtime = message.createtime
    if (message.updatetime != null && message.hasOwnProperty('updatetime')) object.updatetime = message.updatetime
    if (message.ticket != null && message.hasOwnProperty('ticket')) object.ticket = message.ticket
    return object
  }
...
$root.WeAppMemberInfoList = (function () {
  ...
  WeAppMemberInfoList.encode = function encode(message, writer) {
    if (!writer) writer = $Writer.create()
    if (message.infos != null && message.infos.length) for (var i = 0; i < message.infos.length; ++i) $root.WeAppMemberInfo.encode(message.infos[i], writer.uint32(/* id 1, wireType 2 = */10).fork()).ldelim()
    return writer
  }
  ...
  WeAppMemberInfoList.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
    var end = length === undefined ? reader.len : reader.pos + length; var
      message = new $root.WeAppMemberInfoList()
    while (reader.pos < end) {
      var tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
  ...
  WeAppMemberInfoList.fromObject = function fromObject(object) {
    if (object instanceof $root.WeAppMemberInfoList) return object
    var message = new $root.WeAppMemberInfoList()
    if (object.infos) {
      if (!Array.isArray(object.infos)) throw TypeError('.WeAppMemberInfoList.infos: array expected')
      message.infos = []
      for (var i = 0; i < object.infos.length; ++i) {
        if (typeof object.infos[i] !== 'object') throw TypeError('.WeAppMemberInfoList.infos: object expected')
  ...
  WeAppMemberInfoList.toObject = function toObject(message, options) {
    ...
    if (message.infos && message.infos.length) {
      object.infos = []
      for (var j = 0; j < message.infos.length; ++j) object.infos[j] = $root.WeAppMemberInfo.toObject(message.infos[j], options)
    }
    return object
  }
